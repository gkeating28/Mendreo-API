...
# Same-turn risk on a session. Separate from the nightly RISK_LEVEL_CHOICES.
LIVE_RISK_LEVEL_NONE = "none"
LIVE_RISK_LEVEL_LOW = "low"
LIVE_RISK_LEVEL_MODERATE = "moderate"
LIVE_RISK_LEVEL_HIGH = "high"
LIVE_RISK_LEVELS = [
    LIVE_RISK_LEVEL_NONE,
    LIVE_RISK_LEVEL_LOW,
    LIVE_RISK_LEVEL_MODERATE,
    LIVE_RISK_LEVEL_HIGH,
]

SESSION_STATE_GENERAL = "general"
SESSION_STATE_CHECK_IN = "check_in"
SESSION_STATE_STEP_ACTIVE = "step_active"
SESSION_STATE_AWAITING_READY = "awaiting_ready"
SESSION_STATE_COMPLETED = "completed"
SESSION_STATE_ABANDONED = "abandoned"
SESSION_STATES = [
    SESSION_STATE_GENERAL,
    SESSION_STATE_CHECK_IN,
    SESSION_STATE_STEP_ACTIVE,
    SESSION_STATE_AWAITING_READY,
    SESSION_STATE_COMPLETED,
    SESSION_STATE_ABANDONED,
]

CHIP_READY_YES = "Yes, I'm ready"
CHIP_NOT_YET = "Not yet"
CHIP_FINISH = "Finish exercise"

SUGGESTED_RESPONSES_KIND_FREE = "free"
SUGGESTED_RESPONSES_KIND_OFFER = "offer"
SUGGESTED_RESPONSES_KIND_READY = "ready"
SUGGESTED_RESPONSES_KIND_FINISH = "finish"
SUGGESTED_RESPONSES_KINDS = [
    SUGGESTED_RESPONSES_KIND_FREE,
    SUGGESTED_RESPONSES_KIND_OFFER,
    SUGGESTED_RESPONSES_KIND_READY,
    SUGGESTED_RESPONSES_KIND_FINISH,
]

QUESTION_KIND_OPEN = "open"
QUESTION_KIND_CLOSED = "closed"
QUESTION_KIND_READINESS = "readiness"
QUESTION_KIND_NONE = "none"
QUESTION_KINDS = [
    QUESTION_KIND_NONE,
    QUESTION_KIND_OPEN,
    QUESTION_KIND_CLOSED,
    QUESTION_KIND_READINESS,
]

KNOWLEDGE_REVIEW_ACCEPTED = "accepted"
KNOWLEDGE_REVIEW_PENDING = "pending_review"
KNOWLEDGE_REVIEW_REJECTED = "rejected"
KNOWLEDGE_REVIEW_STATUSES = [
    KNOWLEDGE_REVIEW_ACCEPTED,
...
SETTING_KEY_SESSION_INACTIVITY_MINUTES = "session_inactivity_minutes"
...
SESSION_METRIC_SOURCE_KNOWLEDGE = "knowledge"
SESSION_METRIC_SOURCES = [
    SESSION_METRIC_SOURCE_FORM,
    SESSION_METRIC_SOURCE_KNOWLEDGE,
]
...
KNOWLEDGE_ENTRY_SOURCE_EXERCISE = "exercise"
...
KNOWLEDGE_ENTRY_SOURCES = [
    ...
    KNOWLEDGE_ENTRY_SOURCE_EXERCISE,
]
...
KNOWLEDGE_FLOW_GENERAL_CHAT = "general_chat"

KNOWLEDGE_FLOWS = [
    KNOWLEDGE_FLOW_INITIAL,
    KNOWLEDGE_FLOW_RETURN,
    KNOWLEDGE_FLOW_REFRESH,
    KNOWLEDGE_FLOW_GENERAL_CHAT,
]
...
KNOWLEDGE_FOLLOWUP_PERMISSION_YES = "Let's talk about it"
KNOWLEDGE_FOLLOWUP_PERMISSION_NO = "Not now"
KNOWLEDGE_FOLLOWUP_PERMISSION_CHIPS = [
    KNOWLEDGE_FOLLOWUP_PERMISSION_YES,
    KNOWLEDGE_FOLLOWUP_PERMISSION_NO,
]
KNOWLEDGE_FOLLOWUP_PERMISSION_DECLINE_ACK = "No problem."
ONBOARDING_FOLLOWUP_CONSENT_PENDING = "pending"
ONBOARDING_FOLLOWUP_CONSENT_GRANTED = "granted"
ONBOARDING_FOLLOWUP_CONSENT_DECLINED = "declined"
ONBOARDING_FOLLOWUP_CONSENTS = [
    ONBOARDING_FOLLOWUP_CONSENT_PENDING,
    ONBOARDING_FOLLOWUP_CONSENT_GRANTED,
